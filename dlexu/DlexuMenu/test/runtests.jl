...
# !!! Main.UserApp is configured as an alias for Main.DlexuMenu and you might encounter it in some tests
using Main.DlexuMenu, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "DlexuMenu tests" begin
  @includetests ARGS
end
